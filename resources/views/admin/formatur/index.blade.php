...
<section class="section">
    <div class="section-header">
        <h1 style="color:#262626">Calon Formatur IPM SEPANJANG</h1>
        <div class="section-header-breadcrumb">
            <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
            <div class="breadcrumb-item"><a href="#">Data User</a></div>
            <div class="breadcrumb-item">Calon SEPANJANG</div>
        </div>
    </div>  
    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-striped dt-responsive nowrap datatables py-1 px-1" id="myTable">
                    <thead>
                        <tr>
